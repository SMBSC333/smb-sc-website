    ...
    <div>
      ...
      <section class="mpl-hero">
        ...
        <div class="container mpl-hero-content">
          ...
          <h1>My Profit Life</h1>
          <h2 class="mpl-hero-h2">The Principle-Centered AI Framework that helps you master yourself and multiply your impact.</h2>
          <p class="lead">Build the leadership foundation to scale your business with AI—without losing your soul.</p>
