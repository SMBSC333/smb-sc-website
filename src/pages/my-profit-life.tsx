        ...
        <div class="container">
          <div class="grid-2" style="align-items:start; gap:4rem;">
            <div>
              ...
              <p>Most programs give you frameworks. My Profit Life installs the actual systems — in your business, with your team, aligned to your specific goals. By the end of the foundation phase, the business operates differently. Not marginally better. Structurally different.</p>
              <p>The six months build the infrastructure. The ongoing community in Kajabi continues to deepen systems, strengthen leadership, and develop the owner as a principle-centered leader capable of sustaining success without sacrificing family, health, or legacy.</p>
              <p>Because of the hands-on nature of this engagement, a limited number of clients are accepted each year. It is an invitation extended after the Growth Diagnostic when the fit is clear.</p>
            </div>
            <div class="highlight-box">
              <h4 class="mb-3" style="color:var(--color-gold);">My Profit Life — At a Glance</h4>
              <ul class="pain-list">
                <li><strong>Foundation:</strong> 6 months, fully structured with defined phases</li>
                <li><strong>Community:</strong> Ongoing — Kajabi platform, indefinite optimization</li>
                ...
                <li><strong>Execution Support:</strong> Implementation team available for deployment</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section class="section bg-surface">
        <div class="container">
          <div class="section-header">
            <span class="eyebrow">The Operating Framework</span>
            <h2>The Growth Acceleration System — installed across your entire business.</h2>
            <p>My Profit Life is the delivery vehicle for the Growth Acceleration System. Every phase installs a specific layer of the system until the business can grow with structure — not on the back of the owner's effort.</p>
          </div>
          <div class="grid-2" style="gap:2rem; margin-top:2rem;">
            <div class="card card-accent">
              <div class="card-number">01</div>
              <h4 class="mb-2">Assess — Diagnostic Clarity</h4>
              <p style="font-size:0.88rem;">Identify where the business is truly being held back: financial mechanics, positioning, systems, capacity, or lead flow. Nothing is prescribed until the constraint is named.</p>
            </div>
            <div class="card card-accent">
              <div class="card-number">02</div>
              <h4 class="mb-2">Scaling Foundation</h4>
              <p style="font-size:0.88rem;">Build the base everything else rests on — financial foundation, profit architecture, and a Market Dominating Position. Numbers you trust. A message that wins.</p>
            </div>
            <div class="card card-accent">
              <div class="card-number">03</div>
              <h4 class="mb-2">Build the Machine</h4>
              <p style="font-size:0.88rem;">Install the revenue architecture and go-to-market engine. Offer structure, pricing strategy, upsell and cross-sell design, and drip campaigns built to convert.</p>
            </div>
            <div class="card card-accent">
              <div class="card-number">04</div>
              <h4 class="mb-2">Optimize Lead Flow</h4>
              <p style="font-size:0.88rem;">Scale the front end with consistent, leveraged acquisition — primary lead channels, strategic alliances, joint ventures, and referral architecture.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div style="max-width:820px;">
            <div class="phase-block">
              ...
              <div>
                ...
                <p>The Growth Diagnostic goes deep. We review financials, team structure, pipeline, and operations in full. We build the financial baseline — clean books, reliable reporting, and a 13-week cash flow forecast. The team is assessed for role fit and capacity. AI readiness is scored across every operational area. By the end of Phase 1, you have a precise picture of where the business stands and where it is going.</p>
                <ul class="intensive-includes mt-3">
                  ...
                  <li>Team assessment and capacity mapping</li>
            ...
            <div class="phase-block">
              ...
              <div>
                ...
                <p>Systems are only as good as their adoption. This phase focuses on getting the team running the systems without the owner holding their hand. Leadership coaching is integrated to develop the owner's capacity as a leader — not just as the best operator in the room. AI workflows are adopted, tested, and refined based on real usage. Delegation becomes structural, not aspirational.</p>
                <ul class="intensive-includes mt-3">
                  <li>Principle-centered leadership coaching integration</li>
            ...
            <div class="phase-block">
              ...
              <div>
                ...
                <p>The final phase confirms the trajectory and locks in the systems. The business is reviewed against the Value Builder System's 8 key drivers to assess whether growth is translating into enterprise value — not just revenue. The 6-month foundation ends with a confirmed path forward: scale, sustain, or prepare for exit. You leave with a documented operating system and a clear next chapter — then continue building inside the community.</p>
                <ul class="intensive-includes mt-3">
                  <li>Growth Acceleration System full sprint review</li>
      ...
      <section class="section bg-surface">
        <div class="container">
          <div class="grid-2" style="align-items:center; gap:4rem;">
            <div>
              <span class="eyebrow">Beyond the Foundation</span>
              <h2>The community continues where the six months ends.</h2>
              <div class="gold-line"></div>
              <p>My Profit Life is not a program with a finish line. The six-month foundation installs the structure. The ongoing community — hosted in Kajabi — is where owners continue to deepen systems, optimize operations, and develop as principle-centered leaders.</p>
              <p>Members believe that being profitable means living a balanced life that looks beyond the income statement. The community is built for owners navigating success in an AI-driven world without sacrificing family, health, or legacy.</p>
            </div>
            <div class="highlight-box">
              <h4 class="mb-3" style="color:var(--color-gold);">What the ongoing community includes</h4>
              <ul class="intensive-includes">
                <li>Continued system optimization inside Kajabi</li>
                <li>Shared frameworks and accountability structure</li>
                <li>Principle-centered leadership development curriculum</li>
                <li>AI adoption and governance updates as the landscape evolves</li>
                <li>Peer community of owners building profitable, balanced businesses</li>
                <li>Access to our delivery team for execution support</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section class="section bg-dark">
        <div class="container">
          ...
          <div class="grid-3">
            ...
            <div class="card card-accent">
              <h4 class="mb-2">Growth Acceleration System</h4>
              <p style="font-size:0.88rem;">Full Growth Acceleration System implementation — identify hidden profit and margin leaks, create clear 12–18 month roadmaps aligned to your goals.</p>
            </div>
            <div class="card card-accent">
              <h4 class="mb-2">Value Builder System</h4>
              <p style="font-size:0.88rem;">Capitaliz Business Insights engagement — build the business toward the 8 key drivers that determine what buyers will pay.</p>
            </div>
            <div class="card card-accent">
              <h4 class="mb-2">Leadership Development</h4>
            ...
            <div class="card card-accent">
              <h4 class="mb-2">Execution Support Team</h4>
              <p style="font-size:0.88rem;">Access to our implementation team — virtual execution support, financial operations, and AI-assisted workflow deployment for execution after each intensive.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="grid-2" style="align-items:start; gap:4rem;">
            <div>
              ...
              <ul class="pain-list mt-3">
                ...
                <li>Ready for a structured engagement with real accountability</li>
              </ul>
            </div>
            <div>
              ...
              <p>Book the Growth Diagnostic. If My Profit Life is the right next step, that conversation will make it obvious.</p>
              <a href="/growth-diagnostic" class="btn btn-primary mt-3">Book the Growth Diagnostic</a>
              <p style="font-size:0.8rem; color:var(--color-text-muted); margin-top:0.75rem;">Or contact us directly if you have specific questions about the engagement.</p>
